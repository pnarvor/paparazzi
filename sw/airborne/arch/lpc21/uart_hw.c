...
void uart_init_param(struct uart_periph* p, uint16_t baud, uint8_t mode, uint8_t fmode, char * dev) {
...
void uart0_init( void ) {
  ...
  uart_init_param(&uart0, UART0_BAUD, UART_8N1, UART_FIFO_8, "");
...
void uart1_init( void ) {
  ...
  uart_init_param(&uart1, UART1_BAUD, UART_8N1, UART_FIFO_8, "");
